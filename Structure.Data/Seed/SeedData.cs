...
namespace Structure.Data.Seed
{
    public class SeedData : DropCreateDatabaseIfModelChanges<StructureContext>
    {
        protected override void Seed(StructureContext context)
        {
            try
            {
